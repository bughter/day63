...
public class SysAreaProvider {
    ...
    public String insertBath(@Param("areas") List<SysArea> areas){
        ...
        sb.append("INSERT INTO sys_area( parent_id, parent_ids, code, name, type, create_by, " +
    ...
    public String getListByCondition(@Param("aid") Integer aid){
        StringBuilder str=new StringBuilder();
        str.append("select * from sys_area where 1=1");
        if (!StringUtils.isEmpty(aid)) {
            str.append(" and parent_ids like concat('%,',#{aid},',%') ");
        }
        return str.toString();
    }
}
